// function displayHours (ms) {
// 	let text
// 	let hours = Math.floor((ms / (1000 * 60 * 60)) % 24)

// 	const dateHours = new Date(ms)
...
// 		}
// 	}
// 	const test = dateHours.getMinutes() * 60000
// 	return `${hours} ${text} ${minutesNameVar(test)}`
// }
...
function displayHoursMinutes (ms) {
	...
	return ` в ${hours < 10 ? `0${hours}` : hours}:${minutes < 10 ? `0${minutes}` : minutes}`
}
